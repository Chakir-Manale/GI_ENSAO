...
<c:set var="theLocale" value="${not empty param.theLocale ? param.theLocale : pageContext.request.locale}" scope="session"/>
     ...
     <fmt:setBundle basename="com.example.i18n.resources.mylabels"/> 
        <div class="right_content">
            ...
            <a href="index.jsp" ><img src="images/gb.gif" alt="" title="" border="0" /></a>
            <a href="index.jsp?theLocale=de_DE"><img src="images/fr.gif" alt="" title="" border="0" /></a>
            <a href="index.jsp?theLocale=es_ES"><img src="images/de.gif" alt="" title="" border="0" /></a>
            </div>
                <div class="currency">
                <span class="red"><fmt:message key="label.currency"/></span>
                <a href="#">GBP</a>
                <a href="#">EUR</a>
