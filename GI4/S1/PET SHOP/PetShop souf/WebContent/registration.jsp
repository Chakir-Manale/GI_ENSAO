            ...
            <p class="details">
             Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.
                ...
                <div class="form_subtitle">create new account</div>
                 <form name="register" action="UserControllerServlet">          
                    <div class="form_row">
                    <label class="contact"><strong>Username:</strong></label>
                    <input type="text" name="username" class="terms-checkbox" required/>
                    </div>  
                    ...
                    <div class="form_row">
                    	...
                    	<input type="email"  class="contact_input" required/>
                    ...
                    <input type="text" name="adrres" class="contact_input"required />
                    </div>                    
                    ...
                    <div class="form_row">
                    <input type="submit" class="register" name="command" value="SIGNIN" />
                    </div>   
                  </form>     
                </div>  
