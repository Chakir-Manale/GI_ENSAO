...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span><fmt:message key="index.featuredpets"/></div>
        	...
        	<div class="feat_prod_box">
                ...
                <div class="prod_det_box">
                    ...
                    <div class="prod_title"><fmt:message key="index.productname"/></div>
                    ...
                    <a href="details.html" class="more">- <fmt:message key="index.moredetails"/> -</a>
                    <div class="clear"></div>
                    </div>
           ...
           <div class="title"><span class="title_icon"><img src="images/bullet2.gif" alt="" title="" /></span><fmt:message key="index.newpets"/></div> 
           
           <div class="new_products">
           
                    <div class="new_prod_box">
                        <a href="details.html"><fmt:message key="index.productname"/></a>
